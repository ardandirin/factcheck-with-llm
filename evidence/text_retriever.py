...
def parse_args():
    ...
    parser.add_argument('--websites_path', default='./Data/2_Websites/websites_gpt_icl.jsonl', type=str)
    parser.add_argument('--output_path', default='./Data/3_Answers/answers_gpt_icl.jsonl', type=str)
...
if __name__ == "__main__":
    ...
    save_word_counts(word_counts, './Extras/word_counts_gpt_icl.json')
